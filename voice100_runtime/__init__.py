...
MODEL_URLS = {
    'stt_en': [
        'https://github.com/kaiidams/voice100-runtime/releases/download/v0.1/stt_en_conv_base_ctc-20210619.onnx'
    ],
    'tts_en': [
...
#Downloading: "https://github.com/pytorch/vision/archive/master.zip" to /home/kaiida/.cache/torch/hub/master.zip
